...
class := 120
class ::sd +-5
asd .= name.toString!tim no .hia ok .ji mk
cal ...rt
er < 4
er <[4]>
ad c && fd and ok
 ...
 * ok*la
 *\/
 * @param {String} value - Giá trị truyền vào.
 */
...
fn = (a, d) !->*
fn = (a, [b = 9, c], d) !->*
fn = (a, [b = 9, c = 0, d, [g = k, j, r = 1], f = r, g] = [t, c], d, {h, e: i, h2 = 4}) !->
  do it
fm = (i, {j = 9, k}, l) !->
fm = (i, {j = 9, k} = {}, l) !->
...
aa = 13e6
bb = 13E6
[NaN, null, void, Infinity, no, on, yes, false]
@asd.yu
3 + 4 ** -sertt
hmm .= 1
hmm ^= 8
